  ...
  return (
    <>
      ...
      <main className="pt-16">
        {/* Hero */}
        <section className="relative overflow-hidden bg-[#F7F7FF] px-4 py-24 md:py-32">
          <div className="absolute inset-0 opacity-30">
            <div className="absolute -right-20 -top-20 h-72 w-72 rounded-full bg-[#BDD5EA]" />
            <div className="absolute -bottom-16 -left-16 h-56 w-56 rounded-full bg-[#BDD5EA]" />
          </div>
          <div className="relative mx-auto max-w-3xl text-center">
            <h1 className="mb-6 text-4xl font-extrabold leading-tight tracking-tight text-[#495867] md:text-6xl">
              오늘 기분,
              <br />
              <span className="text-[#FE5F55]">어떤 맛?</span>
            </h1>
            <p className="mx-auto mb-10 max-w-lg text-lg text-[#577399]">
              기분을 알려주세요. AI가 당신의 감정에 딱 맞는 레시피를 추천해 드립니다.
            </p>
            <Link
              href="/mood"
        ...
        <section className="bg-white px-4 py-20 md:py-28">
          <div className="mx-auto max-w-5xl">
            <h2 className="mb-4 text-center text-3xl font-bold text-[#495867]">
              Moodish는 이런 서비스예요
            </h2>
            <p className="mx-auto mb-16 max-w-md text-center text-[#577399]">
        ...
        {/* How it works */}
        <section className="bg-[#BDD5EA]/15 px-4 py-20 md:py-28">
          <div className="mx-auto max-w-4xl">
            <h2 className="mb-16 text-center text-3xl font-bold text-[#495867]">
              이렇게 사용해요
            </h2>
        ...
        {/* CTA */}
        <section className="bg-[#FE5F55] px-4 py-20">
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="rounded-2xl border border-[#BDD5EA]/50 bg-[#F7F7FF] p-8 text-center transition-shadow hover:shadow-md">
...
function StepCard({ number, title, description }: { number: string; title: string; description: string }) {
  return (
    <div className="text-center">
      <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#FE5F55] text-xl font-bold text-white">
        {number}
      </div>
      <h3 className="mb-2 text-lg font-bold text-[#495867]">{title}</h3>
      <p className="text-sm leading-relaxed text-[#577399]">{description}</p>
